          ...
          <div className="hidden md:flex items-center gap-2 ml-4">
            {localStorage.getItem('authUser') ? (
              <button
                ...
                className="px-4 py-2 rounded-lg bg-gray-700 text-slate-300 hover:bg-gray-600 text-sm font-medium transition-colors"
              >
                Logout
              </button>
            ) : (
              <>
                <Link to="/login" className="px-4 py-2 rounded-lg bg-blue-600 text-white hover:bg-blue-500 text-sm font-medium transition-colors">Login</Link>
                <Link to="/signup" className="px-4 py-2 rounded-lg bg-slate-700 text-slate-300 hover:bg-slate-600 text-sm font-medium transition-colors">Sign Up</Link>
              </>
            )}
          </div>
