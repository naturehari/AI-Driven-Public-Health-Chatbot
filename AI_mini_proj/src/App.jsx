        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center gap-2 ml-4">
            {localStorage.getItem('authToken') ? (
              <button onClick={() => { localStorage.removeItem('authToken'); window.location.reload(); }} className="px-4 py-2 rounded-lg bg-gray-700 text-slate-300 hover:bg-gray-600">Logout</button>
            ) : (
              <>
                <Link to="/login" className="px-4 py-2 rounded-lg bg-blue-600 text-white hover:bg-blue-500">Login</Link>
                <Link to="/signup" className="px-4 py-2 rounded-lg bg-slate-700 text-slate-300 hover:bg-slate-600">Sign Up</Link>
              </>
            )}
          </div>
